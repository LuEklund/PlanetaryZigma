...
fn addServerArtifacts(
    ...
    if (render_dep) |dep| {
        ...
        system.root_module.addImport("Assets", b.dependency("Assets", .{ .target = target, .optimize = optimize, .tracy = tracy_enable }).module("Assets"));
    ...
    if (render_dep) |dep| {
        ...
        exe.root_module.addImport("Assets", b.dependency("Assets", .{ .target = target, .optimize = optimize, .tracy = tracy_enable }).module("Assets"));
    }
